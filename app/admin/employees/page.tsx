    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Nhân viên chính thức</p>
              <p className="text-2xl font-bold text-green-600">
                {
                  employees.filter(
                    (e) => e.employeeType === EmployeeType.PERMANENT
                  ).length
                }
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900">
                    {selectedEmployee.employeeType === EmployeeType.PERMANENT
                      ? "Chính thức"
                      : "Tạm thời"}
                  </p>
                </div>
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900">
                    {selectedEmployee.monthlySalary
                      ...
                      ? formatCurrency(selectedEmployee.dailySalary) + "/ngày"
                      : "N/A"}
                  </p>
                </div>
                <div>
