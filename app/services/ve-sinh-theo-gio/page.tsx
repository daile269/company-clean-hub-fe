            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Dịch vụ vệ sinh theo giờ của Opti Clean mang đến sự linh hoạt tối đa cho 
                    khách hàng. Bạn có thể thuê dịch vụ theo từng giờ, phù hợp với nhu cầu và 
                    ngân sách của mình. Đây là giải pháp lý tưởng cho những ai cần vệ sinh 
                    nhanh chóng, định kỳ hoặc đột xuất.
                  </p>
                  <p>
                    Với đội ngũ nhân viên được đào tạo bài bản, chúng tôi đảm bảo mỗi giờ làm việc 
                    đều mang lại hiệu quả cao nhất. Chúng tôi sử dụng thiết bị chuyên dụng, hóa 
                    chất an toàn và quy trình làm việc khoa học để tối ưu hóa thời gian và chất lượng.
                  </p>
                  <p>
                    Dịch vụ phù hợp cho: gia đình, văn phòng nhỏ, cửa hàng, nhà trọ, căn hộ, 
                    hoặc bất kỳ không gian nào cần vệ sinh nhanh chóng và hiệu quả.
                  </p>
                </div>
              </div>
              <div>
              ...
              <Link href="/services/ve-sinh-kinh-alu" className="block">
                <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition cursor-pointer">
                  ...
                  <p className="text-gray-600 mb-4">
                    Dịch vụ vệ sinh kính, cửa nhôm kính chuyên nghiệp cho
                    tòa nhà, văn phòng với đội ngũ lành nghề và thiết bị
                    hiện đại.
                  </p>
              ...
              <Link href="/services/tong-ve-sinh" className="block">
                <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition cursor-pointer">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    hoặc định kỳ nhanh chóng với đội ngũ chuyên nghiệp.
                  </p>
                  <span className="text-blue-600 font-medium hover:text-blue-800">
                    Xem Thêm →
                  </span>
              ...
              <Link href="/services/ve-sinh-nha-xuong" className="block">
                <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition cursor-pointer">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    nghiệp, đảm bảo sạch sẽ, an toàn và vệ sinh lao động.
                  </p>
                  <span className="text-blue-600 font-medium hover:text-blue-800">
                    Xem Thêm →
                  </span>
