...
export default function VeSinhVanPhong() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/vs-vp.jpg')`,
        }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-4">Vệ Sinh Văn Phòng</h1>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Việc tạo ra một môi trường làm việc sạch sẽ, thoáng mát cũng
                    như một không gian trong lành góp phần nâng cao hiệu quả
                    công việc và tinh thần thoải mái trong công việc — đây là
                    một trong những nhu cầu quan trọng của con người.
                  </p>
                  <p>
                    Với bề dày kinh nghiệm, chúng tôi mang đến dịch vụ với chất
                    lượng tốt nhất. Nhờ am hiểu sâu sắc về tính chất hoạt động
                    của từng loại hình, Opti Clean đã xây dựng quy trình chuẩn
                    hóa và được kiểm chứng qua nhiều năm cho nhiều loại hình
                    khác nhau.
                  </p>
                  <p>
