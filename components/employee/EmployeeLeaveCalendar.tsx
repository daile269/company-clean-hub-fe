              ...
              <div className="mb-6">
                ...
                >
                  <input
                    ...
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none cursor-pointer text-slate-700 placeholder-slate-400"
                  />
                  <input
                    ref={dateInputRef}
                    type="date"
